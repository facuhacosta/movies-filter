...
const ClientMovieDetails = ({movieId}:{movieId: number}) => {
  ...
  const runeTimeString = (runtime: number) => 
    `${Math.floor(runtime / 60)}:${(runtime % 60).toLocaleString('en-US', { minimumIntegerDigits: 2, useGrouping: false }) } Hs`
            ...
            <CardContent>
              ...
              <Box gap={2} display='flex'>
                <Typography variant="body2" component="span">
                  Budget: ${detailedMovie.budget.toLocaleString('en-US')}
                </Typography>
                <Typography variant="body2" component="span">
                  Revenue: ${detailedMovie.revenue.toLocaleString('en-US')}
                </Typography>
